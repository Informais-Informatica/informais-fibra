    ...
    <footer className="relative bg-[#0F172A] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center gap-6 pb-8 border-b border-white/5">
          <Image src="/logo.png" alt="Informais Telecom" width={220} height={66} className="h-16 w-auto object-contain shrink-0" />
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="font-body text-xs text-slate-500">© {currentYear} Informais Fibra — Todos os Direitos Reservados.</p>

          <div className="flex items-center gap-4">
            <p className="font-body text-xs text-slate-600">CNPJ: 27.816.328/0001-37 · Este site não coleta dados pessoais.</p>
            <a
              href="/contrato.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="font-body text-xs text-slate-400 hover:text-[#FBBF24] flex items-center gap-1.5 transition-colors shrink-0"
            >
              <svg
                className="w-3.5 h-3.5"
                fill="none"
